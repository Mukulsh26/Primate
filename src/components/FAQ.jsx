...
const FAQs = () => {
  ...
  return (
    <section className="bg-black text-orange-500 py-16 px-4">
  ...
  <div
    key={index}
    className="border border-orange-500 rounded-xl p-6 cursor-pointer hover:shadow-[0_0_20px_#fff] transition-all duration-300"
